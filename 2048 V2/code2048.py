...
mixer.init()
mixer.music.load("Images/Dark Souls III OST - Soul of Cinder.mp3")
mixer.music.set_volume(0.7)
fond = pygame.image.load("Images/#fond.jpg").convert()
victoire = pygame.image.load("Images/victcarry.jfif").convert()
victoire = pygame.image.load("Images/victcarry.jfif").convert_alpha()
defaite = pygame.image.load("Images/deafed.png").convert()
defaite = pygame.image.load("Images/deafed.png").convert_alpha()
chiffre2 = pygame.image.load("Images/2.png").convert()
chiffre2 = pygame.image.load("Images/2.png").convert_alpha()
chiffre4 = pygame.image.load("Images/4.png").convert()
chiffre4 = pygame.image.load("Images/4.png").convert_alpha()
chiffre8 = pygame.image.load("Images/8.png").convert()
chiffre8 = pygame.image.load("Images/8.png").convert_alpha()
chiffre16 = pygame.image.load("Images/16.png").convert()
chiffre16 = pygame.image.load("Images/16.png").convert_alpha()
chiffre32 = pygame.image.load("Images/32.png").convert()
chiffre32 = pygame.image.load("Images/32.png").convert_alpha()
chiffre64 = pygame.image.load("Images/64.png").convert()
chiffre64 = pygame.image.load("Images/64.png").convert_alpha()
chiffre128 = pygame.image.load("Images/128.png").convert()
chiffre128 = pygame.image.load("Images/128.png").convert_alpha()
chiffre256 = pygame.image.load("Images/256.png").convert()
chiffre256 = pygame.image.load("Images/256.png").convert_alpha()
chiffre512 = pygame.image.load("Images/512.png").convert()
chiffre512 = pygame.image.load("Images/512.png").convert_alpha()
chiffre1024 = pygame.image.load("Images/1024.png").convert()
chiffre1024 = pygame.image.load("Images/1024.png").convert_alpha()
chiffre2048 = pygame.image.load("Images/2048.png").convert()
chiffre2048 = pygame.image.load("Images/2048.png").convert_alpha()
