...
mixer.init()
mixer.music.load("Images beta/Rick Astley - Never Gonna Give You Up (Official Music Video).mp3")
mixer.music.set_volume(0.7)
fond = pygame.image.load("Images beta/#fond.jpg").convert()
victoire = pygame.image.load("Images beta/victcarry.png").convert()
victoire = pygame.image.load("Images beta/victcarry.png").convert_alpha()
defaite = pygame.image.load("Images beta/deafed.png").convert()
defaite = pygame.image.load("Images beta/deafed.png").convert_alpha()
chiffre2 = pygame.image.load("Images beta/2.jpg").convert()
chiffre2 = pygame.image.load("Images beta/2.jpg").convert_alpha()
chiffre4 = pygame.image.load("Images beta/4.jpg").convert()
chiffre4 = pygame.image.load("Images beta/4.jpg").convert_alpha()
chiffre8 = pygame.image.load("Images beta/8.png").convert()
chiffre8 = pygame.image.load("Images beta/8.png").convert_alpha()
chiffre16 = pygame.image.load("Images beta/16.jpg").convert()
chiffre16 = pygame.image.load("Images beta/16.jpg").convert_alpha()
chiffre32 = pygame.image.load("Images beta/32.png").convert()
chiffre32 = pygame.image.load("Images beta/32.png").convert_alpha()
chiffre64 = pygame.image.load("Images beta/64.png").convert()
chiffre64 = pygame.image.load("Images beta/64.png").convert_alpha()
chiffre128 = pygame.image.load("Images beta/128.png").convert()
chiffre128 = pygame.image.load("Images beta/128.png").convert_alpha()
chiffre256 = pygame.image.load("Images beta/256.png").convert()
chiffre256 = pygame.image.load("Images beta/256.png").convert_alpha()
chiffre512 = pygame.image.load("Images beta/512.png").convert()
chiffre512 = pygame.image.load("Images beta/512.png").convert_alpha()
chiffre1024 = pygame.image.load("Images beta/1024.png").convert()
chiffre1024 = pygame.image.load("Images beta/1024.png").convert_alpha()
chiffre2048 = pygame.image.load("Images beta/2048.png").convert()
chiffre2048 = pygame.image.load("Images beta/2048.png").convert_alpha()
...
def Username():
    ...
    txt = font.render('Votre nom : ',1,(255,255,255))
    active = False
    username = ''
    done = False
    while not done:
...
def Jeu():
    ...
    pseudo = font.render(str(nom),1,(255,255,255))
    total = 0
    mixer.music.play(-1)
    grille = debutJeu()
...
def afficheScore(Tmax , total):
    ...
    if Tmax < total:
        Tmax = total
    ScrMax = font.render(str(Tmax),1,(255,255,255))
    Scr = font.render(str(total),1,(255,255,255))
